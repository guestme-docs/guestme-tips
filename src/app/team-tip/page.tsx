...
import { Star, Send, Target } from 'lucide-react'
...
export default function TeamTipPage() {
  ...
  const goalProgress = (team.currentAmount / team.goalAmount) * 100
      ...
      <div className="max-w-md mx-auto px-4">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-200/50 p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm">Оставьте чаевые и отзыв для нашей команды</p>
          </div>

          {/* 2. Фото и имя команды */}
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div className="flex-1">
              <div className="font-bold text-xl text-gray-900">{team.name}</div>
              <div className="text-gray-500 text-sm">{team.restaurant}</div>
            </div>
          </div>

          {/* 3. Цель (на что команда копит) */}
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-5 border border-emerald-200/50 mb-6">
            ...
            <p className="text-gray-700 text-sm mb-3">{team.goal}</p>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Прогресс</span>
                <span className="font-medium text-gray-900">{team.currentAmount.toLocaleString()} / {team.goalAmount.toLocaleString()} ₽</span>
              </div>
          ...
          {/* 5. Если оценка поставлена - поле для ввода комментария с встроенной кнопкой отправить */}
          {rating > 0 && (
            <div className="mb-6">
          ...
          {/* 8. Галка согласия на оплату комиссии сервиса за команду, 6%, по умолчанию включена */}
          <div className="mb-4">
